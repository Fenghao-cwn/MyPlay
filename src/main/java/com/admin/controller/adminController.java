...
//	模糊查询
	...
	public int editShop(Integer id,String name,String picture,Float price,String introduce,Integer type_id){
		Goods goods = new Goods(id,name,picture,price,introduce,type_id);
